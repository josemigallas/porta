...
Given "referrer filters {are} required for the service of {provider}" do |enabled, provider|
  provider.default_service.update!(referrer_filters_required: !enabled.blank?)
end
