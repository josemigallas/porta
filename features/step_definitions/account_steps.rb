...
Given "account {account} has address {string}" do |account, address|
...
Given "account {account} has telephone number {string}" do |account, telephone_number|
  account.update!(telephone_number: telephone_number)
end

Given "admin of account {account} has email {string}" do |account, email|
  account.admins.first.update!(email: email)
end

Given "account {account} is deleted" do |account|
  account.delete
end
...
Then "account {account} should be {state}" do |account, state|
