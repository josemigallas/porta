...
# TODO: need param-type for legal terms?
Then "{provider} should have {string} creation binded to legal terms {string}" do |provider, scope, legal_terms|
