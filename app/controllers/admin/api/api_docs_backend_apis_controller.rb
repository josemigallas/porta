...
class Admin::Api::ApiDocsBackendApisController < Admin::Api::BaseController
  ...
  def api_docs
    current_account.all_api_docs.owned_by_backend_api
  end
  ...
  def api_docs_params(*extra_params)
    ...
    if backend_api_id.present?
      permitted_params[:owner_type] = 'BackendApi'
      permitted_params[:owner_id] = backend_api_id
    end
